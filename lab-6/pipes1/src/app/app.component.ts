...
@Component({
  ...
  template: `<div>Без форматування: {{ myDate }}</div>
    ...
    <div>
      Число, з якого вираховуємо квадратний корінь:
      {{ numberForRootCalculation }}
    </div>
    <div>
      Число після вираховування квадратного кореня:
      {{ numberForRootCalculation | squareRoot }}
    </div> `,
})
export class AppComponent {
  ...
  numberForRootCalculation: number = 9;
}
